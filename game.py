...
def game_main(choice_machine_color, choice_user_color):
    ...
    while finish_game == False:
        if count_round == 0 :
            ...
            print(finish_game)
            # if choice_machine_color in  tab_position_possible[0:3] :
            #     print(tab_position_possible[0:3])
            #     finish_game = True
            #     print("C'est la machine qui a gagné!!! \n")
            #     print_tab()
            # elif  choice_user_color in  tab_position_possible[0:3] :
            #     finish_game = True
            #     print("C'est toi qui a gagné!!! \n")
            #     print_tab()
            # elif choice_machine_color in  tab_position_possible[3:6] :
            #     finish_game = True
            #     print("C'est la machine qui a gagné!!! \n")
            #     print_tab()
            # elif choice_user_color in  tab_position_possible[3:6] :
            #     finish_game = True
            #     print("C'est toi qui a gagné!!! \n")
            #     print_tab()
            # elif choice_machine_color in  tab_position_possible[6:8] :
            #     finish_game = True
            #     print("C'est la machine qui a gagné!!! \n")
            #     print_tab()
            # elif choice_user_color in  tab_position_possible[6:8] :
            #     finish_game = True
            #     print("C'est toi qui a gagné!!! \n")
            #     print_tab()
            # elif choice_machine_color in  tab_position_possible[0,3,6] :
            #     finish_game = True
            #     print("C'est la machine qui a gagné!!! \n")
            #     print_tab()
            # elif choice_user_color in  tab_position_possible[0,3,6] :
            #     finish_game = True
            #     print("C'est toi qui a gagné!!! \n")
            #     print_tab()
            # elif choice_machine_color in  tab_position_possible[1,4,7] :
            #     finish_game = True
            #     print("C'est la machine qui a gagné!!! \n")
            #     print_tab()
            # elif choice_user_color in  tab_position_possible[1,4,7] :
            #     finish_game = True
            #     print("C'est toi qui a gagné!!! \n")
            #     print_tab()
            # elif choice_machine_color in  tab_position_possible[2,5,8] :
            #     finish_game = True
            #     print("C'est la machine qui a gagné!!! \n")
            #     print_tab()
            # elif choice_user_color in  tab_position_possible[2,5,8] :
            #     finish_game = True
            #     print("C'est toi qui a gagné!!! \n")
            #     print_tab()
            # elif choice_machine_color in  tab_position_possible[0,4,8] :
            #     finish_game = True
            #     print("C'est la machine qui a gagné!!! \n")
            #     print_tab()
            # elif choice_user_color in  tab_position_possible[0,4,8] :
            #     finish_game = True
            #     print("C'est toi qui a gagné!!! \n")
            #     print_tab()
            # elif choice_machine_color in  tab_position_possible[2,4,6] :
            #     finish_game = True
            #     print("C'est la machine qui a gagné!!! \n")
            #     print_tab()
            # elif choice_user_color in  tab_position_possible[2,4,6] :
            #     finish_game = True
            #     print("C'est toi qui a gagné!!! \n")
            #     print_tab()
        elif count_round == 2 : 
